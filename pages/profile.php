...
if ($_POST) {
	...
	{
		$_warning .= __('profile.warning_u_already');
	}
...
<form method="post" role="form" class="form-horizontal" autocomplete="off">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			...
			<input name="password" type="password" data-old-value="" class="form-control password-required" placeholder="<?= __('profile.password_new')?>">
			<br>
			<input name="password_old" type="password" class="form-control" placeholder="<?= __('profile.password_old')?>l">
		</div>
	</div>
	<div class="form-group">

...
/* 
 * MySQLDump - PHP
 * Copyright (c) 2014, clouddueling https://github.com/clouddueling/mysqldump-php
 *
...
class Mysqldump
{
    ...
    public function start($filename = '')
    {
        ...
        return $this->_compressManager->close();
    }
...
class CompressBzip2 extends CompressManagerFactory
{
    ...
    {
        $this->_fileHandler = bzopen($filename, "w");
...
class CompressBuffer extends CompressManagerFactory
{
	private $buffer = '';
